...
const Table = () => {
    ...
    return (
        <div className="Bigtable h-75 col-12 px-0">
            ...
            <div id="table2" className={classNames("tableDefault", Drag==2 && "drag")}>
            ...
            <div id="table3" className={classNames("tableDefault", Drag==3 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
            ...
            <div id="table4" className={classNames("tableDefault", Drag==4 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
                        Message & Call
                    <br />
            ...
            <div id="table5" className={classNames("tableDefault", Drag==5 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
            ...
            <div id="table6" className={classNames("tableDefault", Drag==6 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
                        Dashboard
                    <br />
            ...
            <div id="table7" className={classNames("tableDefault", Drag==7 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
                        Health
                    <br />
            ...
            <div id="table8" className={classNames("tableDefault", Drag==8 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
            ...
            <div id="table9" className={classNames("tableDefault", Drag==9 && "drag")}>
                <div className="text_upper">
                    <h3 className="text_head">
                        Aesthetic design
                    <br />
