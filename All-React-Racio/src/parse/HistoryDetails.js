...
const HistoryDetails = ({ log }) => {
    var date = moment(new Date(946728000000 + log.header.time * 1000)).format('YYYY-MM-DD HH:mm:ss');
    ...
    var chartProps = {
        title: 'Record Chart',
        chartData: {
            labels: Array.from(new Array(log.body.length), (_, i) => (i === 0 ? 1 : i)),
            datasets: [
                {
                    label: 'Speed',
                    fill: 'start',
    ...
    return (
        <Container fluid className="main-content-container px-4">
            ...
            <Row noGutters className="page-header py-4">
                <Col xs="12" sm="6" className="text-sm-left mb-3">
                    <h5>My Trimm</h5>
                    <span className="text-uppercase page-subtitle">{date}</span>
                </Col>
            </Row>
