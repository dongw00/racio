...
<div className="subscribe section bg-dark py-4">
    ...
    <p className="text-muted col-md-6 text-center mx-auto">
        ...
        libero ipsum eius rem, facere deserunt repudiandae autem sapiente
        dolores.
      </p>
    <form className="form-inline d-table mb-5 mx-auto" action="/">
        <div className="form-group">
            <input className="form-control border-0 mr-3 mb-2" type="text" placeholder="Email address" />
            <button className="btn btn-success mb-2" type="submit">Subscribe</button>
        </div>
    </form>
</div>
);
