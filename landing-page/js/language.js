...
function ChangeLanguage(){  
    ...
    if( language === "KR"){
        ...
        document.getElementById('text_fit1_sub').innerHTML = "Simple and clean UI, It is Easy to use";
        document.getElementById('text_fit2_sub').innerHTML = "We Protect personal information thoroughly and completely";
        document.getElementById('text_fit3_sub').innerHTML = "You can manage your data through the file system";
        document.getElementById('text_fit4_sub').innerHTML = "Anytime, anywhere, you can enjoy trimm One!";
        ...
        document.getElementById('text_fit1_sub').innerHTML = "간편하고 깔끔한 UI, 누구나 쉽게사용할 수 있습니다";
        document.getElementById('text_fit2_sub').innerHTML = "철저하고 완벽하게 개인 정보를 보호합니다";
        document.getElementById('text_fit3_sub').innerHTML = "파일 시스템을 통해 데이터를 관리할 수 있습니다";
        document.getElementById('text_fit4_sub').innerHTML = "언제 어디서나 사용할 수 있는 trimm One!";
